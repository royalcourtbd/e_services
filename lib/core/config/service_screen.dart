import 'package:e_services/core/utility/logger_utility.dart';
...
///
/// The `ServiceScreen` class provides static methods and properties to access
...
/// ```dart
/// ServiceScreen.setUp();
/// double screenWidth = ServiceScreen.width;
/// double screenHeight = ServiceScreen.height;
/// ```
///
/// Rationale:
///
/// - The `ServiceScreen` class provides a convenient way to access the screen dimensions
...
/// the `ServiceScreen` class benefits from its reliability and compatibility with different
...
class ServiceScreen {
  ...
  static Size get _size => MediaQuery.sizeOf(EServices.globalContext);
  ...
  static void _resetIfInvalid() {
    if (_width! < 10 || _height! < 10) {
      logErrorStatic(
        'ServiceScreen size not initialized. Please initialize ServiceScreen and try again.',
        "Service_screen",
      );
      _width = null;
      _height = null;
...
extension ServiceScreenWidth on Widget {
  static double? _onePercentWidth;

  double get onePercentWidth {
    const double onePercent = 0.01;
    _onePercentWidth ??= ServiceScreen.width * onePercent;
  ...
  double get twoPercentWidth {
    ...
    _twoPercentWidth ??= ServiceScreen.width * twoPercent;
  ...
  double get fiftyPercentHeight {
    ...
    _fiftyPercentHeight ??= ServiceScreen.height * fiftyPercent;
  ...
  double get threePercentWidth {
    ...
    _threePercentWidth ??= ServiceScreen.width * threePercent;
  ...
  double get sixPercentWidth {
    ...
    _sixPercentWidth ??= ServiceScreen.width * sixPercent;
  ...
  double get sevenPercentWidth {
    ...
    _sevenPercentWidth ??= ServiceScreen.width * sevenPercent;
  ...
  double get eightPercentWidth {
    ...
    _eightPercentWidth ??= ServiceScreen.width * eightPercent;
  ...
  double get tenPercentWidth {
    ...
    _tenPercentWidth ??= ServiceScreen.width * tenPercentWidth;
  ...
  double get fortyPercentWidth {
    ...
    _fortyPercentWidth ??= ServiceScreen.width * fortyPercent;
  ...
  double get thirtyPercentWidth {
    ...
    _thirtyPercentWidth ??= ServiceScreen.width * thirtyPercentWidth;
  ...
  double get seventyPercentWidth {
    ...
    _seventyPercentWidth ??= ServiceScreen.width * seventyPercent;
  ...
  double get tweentyEightPercentWidth {
    ...
    _tweentyEightPercentWidth ??=
        ServiceScreen.width * tweentyEightPercentWidth;
  ...
  double get twentyPercentWidth {
    ...
    _twentyPercentWidth ??= ServiceScreen.width * twentyPercentWidth;
  ...
  double get twentyFivePercentWidth {
    ...
    _twentyFivePercentWidth ??= ServiceScreen.width * twentyFivePercentWidth;
  ...
  double get twentySixPercentWidth {
    ...
    _twentySixPercentWidth ??= ServiceScreen.width * twentySixPercentWidth;
  ...
  double get twentyThreePercentWidth {
    ...
    _twentyThreePercentWidth ??= ServiceScreen.width * twentyThreePercentWidth;
  ...
  double get fourtyPercentWidth {
    ...
    _fourtyPercentWidth ??= ServiceScreen.width * fourtyPercentWidth;
  ...
  double get twentyPercentHeight {
    ...
    _twentyPercentHeight ??= ServiceScreen.height * twentyPercent;
  ...
  double get tenPercentHeight {
    ...
    _tenPercentHeight ??= ServiceScreen.height * tenPercentHeight;
  ...
  double get twelvePercentHeight {
    ...
    _twelvePercentHeight ??= ServiceScreen.height * twentyPercent;
  ...
  double get fourteenPercentHeight {
    ...
    _fourteenPercentHeight ??= ServiceScreen.height * fourteenPercentHeight;
  ...
  double get tweentyPercentHeight {
    ...
    _tweentyPercentHeight ??= ServiceScreen.height * tweentyPercentHeight;
...
double? _serviceScreenWidthQuarterPercentage;
...
/// `_widthPercent`, and `_serviceScreenWidthQuarterPercentage`), subsequent conversions for the same
...
extension DeviceExt on num {
  ...
  /// `_calculateServiceScreenWidthQuarterPercentage` function.
  ///
  ///
  /// Example usage:
  ///
  ...
  /// ```
  double get px {
    _serviceScreenWidthQuarterPercentage ??=
        _calculateServiceScreenWidthQuarterPercentage();
    return this * (_serviceScreenWidthQuarterPercentage ?? 0);
  }
  ...
  double get percentHeight {
    _heightPercent ??= ServiceScreen.height / 100;
  ...
  double get percentWidth {
    _widthPercent ??= ServiceScreen.width / 100;
    return this * (_widthPercent ?? 0);
  }
}

/// Calculates the quarter percentage of the Service screen width.
///
/// The `_calculateServiceScreenWidthQuarterPercentage` function calculates and returns
/// a factor that represents a quarter of the Service screen width percentage. It is used
/// by the `px` method in the `DeviceExt` extension to convert numerical values to pixels.
/// The quarter percentage is calculated as the ratio between one-quarter of the Service
/// screen width and 100.
///
/// This function assumes that the `ServiceScreen` class, containing the width property,
/// is properly defined and accessible within the scope of this function.
double _calculateServiceScreenWidthQuarterPercentage() {
  return (ServiceScreen.width / 3.9) / 100;
}
